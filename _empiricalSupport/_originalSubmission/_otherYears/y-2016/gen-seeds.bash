...
time python ../src/main.py input-data/cores-6x4.txt input-data/them-dic-16.txt input-data/3-prefix.txt input-data/3-substr.txt input-data/3-suffix.txt input-data/4-prefix.txt input-data/4-substr.txt input-data/4-suffix.txt input-data/5-substr.txt

sed -i 's/dic-21/dic-16/g' puzzle*.pzl

...
\ie Adi: please write, use {\tt [$\backslash$cite]} for citations
...
\vspace{-0.25cm}
\caption{pattern: a rectangular grid with no letters}
\end{figure}
...
\eei
\ie Feed the puzzle into {\sc Wombat} and generate multiple solutions
\eei
...
%\vspace{-0.15cm}
\caption{core: a pattern filled with letters. Each word is a substring of a thematic word}
\end{figure}

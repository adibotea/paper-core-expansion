...
A core is expanded into a seed, a partial solution with
a subset of variables defined and instantiated.
Seeds are further extended into full solutions.
We demonstrate our ideas in the Romanian Crosswords Competition Problem.
...
Our approach takes as input the size of a rectangular core to consider.\vb{and ``the locations of zero or more black cells inside the core''?}

...
Human experts too sometimes take such a strategy.
...
is provided (including the black cells)~\cite{DBLP:conf/socs/BoteaB21,Botea_Bulitko_2022}.
...
At this step, we set {\sc Wombat} to enumerate all solutions, which are precisely the 
...
\caption{\sc Multi-resolution MAP Elites.}
\label{alg:mrme}
\end{algorithm}

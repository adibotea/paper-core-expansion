...
The problem is NP-complete \cite{}.
...
Similarly to crosswords grid generation, the problem is NP-complete \cite{}.
...
Seconly, adding black cells dynamically has the important consequence that

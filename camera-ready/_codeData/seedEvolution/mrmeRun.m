...
g(1).cg = seedG.cg;
g(1).fn = seedG.fn;
g(1).score = seedG.fnscore; %extractScoreAdiSeedFN(seedG.fn);
g(1).hm = [];
g(1).p = seedG.p;
...
while (true)
    ...
    [offspringScores, ~, offspringHM] = wombatScore(offspring,wombat.targetScore,wombat.timeLimit,wombat.jobID,wombat.weight,wombat.year,offspringC,false);
